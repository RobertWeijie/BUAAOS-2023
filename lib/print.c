...
//	char R;
	...
	for (;;) {
		...
		//print_str(out, data, fmt - 1, 0, 0);
                                
		/* check "are we hitting the end?" */
		/* Exercise 1.4: Your code here. (3/8) */ //这个是对的
                           
		if((*fmt) =='\0' ){
			break;}

		/* we found a '%' */
		/* Exercise 1.4: Your code here. (4/8) */ //这个是对的
		//fmt++;
...
width = 10 * width + (*fmt++ - '0');
		...
		/* check for long */
		/* Exercise 1.4: Your code here. (7/8) */ //这个是对的
	long_flag = 0;
		     if(*fmt == 'l'){
                            long_flag = 1;
                            fmt++;
		...
		if (long_flag) {
			 ...
			 */
			/* Exercise 1.4: Your code here. (8/8) */ //这个是对的
			if(num < 0){
				num =-num;
                                    neg_flag = 1;
                            }
